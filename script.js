    ...
    const pdfMaterials = [
        {
            ...
            thumbnail: "https://via.placeholder.com/300x400/0a0a1a/00f0ff?text= Mecânica+Quântica+1", description: "Introdução aos conceitos fundamentais da física quântica",
            pages: 45,
            year: 2023,
            downloadUrl: "#"
        }, {
            title: "Relatividade Geral",
            thumbnail: "https://via.placeholder.com/300x400/0a0a1a/00f0ff?text=Relatividade",
            description: "Teoria de Einstein sobre gravitação e a curvatura do espaço-tempo",
            pages: 62,
            year: 2023,
            downloadUrl: "#"
        },
        {
            ...
            thumbnail: "https://via.placeholder.com/300x400/0a0a1a/00f0ff?text=Termodinâmica",
            description: "Leis da termodinâmica e suas aplicações em sistemas complexos",
            pages: 38,
            year: 2022,
            downloadUrl: "#"
        },
